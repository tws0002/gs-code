...
echo "Setting up Maya 2015 environment..."

set GSMAYA=%GSTOOLS%/maya
set GSMAYASCRIPT=%GSMAYA%/scripts
set GSMAYAMEL=%GSMAYASCRIPT%/mel

set PYTHONPATH=%GSMAYASCRIPT%;%GSMAYASCRIPT%/python;c:/Program Files/Autodesk/Maya2015/Python/Lib/site-packages
set MAYA_SHELF_PATH=%GSMAYA%/shelves/2015
...
set MAYA_PLUG_IN_PATH=%GSMAYA%/plug-ins/2015
...
goto loop
:endlaunchmayarender
echo "Starting Maya 2015 Render."
if exist "C:\Program Files\Autodesk\Maya2015\bin\Render.exe" (
	"C:\Program Files\Autodesk\Maya2015\bin\Render.exe" %params%
) else (
	echo "Maya 2015 not installed on this computer"
	pause
)
goto end

:launchmaya
echo "Starting Maya 2015."
if exist "C:\Program Files\Autodesk\Maya2015\bin\maya.exe" (
